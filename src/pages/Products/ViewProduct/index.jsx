...
const ViewProduct = ({ match, dispatch, productDetails }) => {
    ...
    <div className="container mx-auto">
      ...
      >
                ...
                <Col xl={8} lg={8} md={24} sm={24} xs={24}>
                  <div className="bg-white shadow rounded">
                    <div className="p-3 flex justify-between border-b text-sm text-gray-700 font-medium">
                      <div>Brand</div>
                      <div>
                        <span className="text-blue-600">{productDetails?.brand_info?.name}</span>
                        {productDetails?.brand_info?.label && (
                    ...
                    <div className="p-3 flex justify-between  border-b text-sm text-gray-700 font-medium">
                      <div>Family</div>
                      <div>
                        <span className="text-blue-600">{productDetails?.family_info?.name}</span>
                        {productDetails?.family_info?.label && (
                          <span className="text-blue-600">
                            {' '}
                            - {productDetails?.family_info?.label}
                          </span>
                    ...
                    <div className="p-3 flex justify-between border-b text-sm text-gray-700 font-medium">
                      <div>Type</div>
                      <div>
                        <span className="text-blue-600">{productDetails?.type_info?.name}</span>
                        {productDetails?.type_info?.label && (
                          <span className="text-blue-600">
                            {' '}
                            - {productDetails?.type_info?.label}
                          </span>
                    ...
                    <div className="p-3 flex justify-between border-b text-sm text-gray-700 font-medium">
                      <div>Sub-type</div>
                      <div>
                        <span className="text-blue-600">{productDetails?.sub_type_info?.name}</span>
                        {productDetails?.sub_type_info?.label && (
                          <span className="text-blue-600">
                            {' '}
                            - {productDetails?.sub_type_info?.label}
                          </span>
                    ...
                    <div className="p-3 flex justify-between text-sm text-gray-700 font-medium">
                      ...
                      <div>
                        <span className="text-blue-600">
                          {productDetails?.department_info?.name}
                        </span>
                        {productDetails?.department_info?.label && (
                          <span className="text-blue-600">
                            {' '}
                            - {productDetails?.department_info?.label}
                          </span>
                  ...
                  <div className={`${styles.AttachmentContainer} bg-white shadow rounded`}>
                    <div className="bg-white p-4 border-b">
                      ...
                      <DocumentView
                        ...
                        contents={productDetails?.model_content}
                      />
                    </div>
                    <div className="bg-white p-4 border-b">
                      ...
                      <DocumentView
                        ...
                        value={moment(productDetails?.installation_date).format('LL')}
                        documentNameProperty="name"
                        contents={productDetails?.installation_date_content}
                      />
                    </div>
                    <div className="bg-white p-4 border-b">
                      ...
                      <DocumentView
                        ...
                        documentNameProperty="name"
                        contents={productDetails?.serial_number_content}
                      />
                    </div>
                  </div>
                </Col>
        ...
        <div className=" mb-4 mt-4">
          <Collapse>
            <Panel
              disabled={productDetails?.has_warranty !== 'Y'}
              className="bg-white"
                ...
                <Col xl={8} lg={8} md={24} sm={24} xs={24}>
                  <div className={`${styles.BackgroundColor} shadow rounded`}>
                    <div className="p-3 flex justify-between border-b text-sm text-gray-700 font-medium">
                      ...
                      <div>
                        <span className="text-blue-600">
                          {moment(productDetails?.warranty_start_date).format('LL')}
                        </span>
                      </div>
                    </div>
                    <div className="p-3 flex justify-between text-sm text-gray-700 font-medium">
                      ...
                      <div>
                        <span className="text-blue-600">
                          {moment(productDetails?.warranty_end_date).format('LL')}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <Col xl={16} lg={16} md={24} sm={24} xs={24}>
                  <div className={`${styles.AttachmentContainer} bg-white shadow rounded`}>
                    <div className="bg-white p-4 border-b">
                      ...
                      <DocumentView
                        name="Warranty"
                        value={`${productDetails?.warranty} year(s)`}
                        documentNameProperty="name"
                        contents={productDetails?.warranty_content}
                      />
                    </div>
                    <div className="bg-white p-4 border-b">
                      ...
                      <DocumentView
                        name="PMS Number"
                        value={productDetails?.pms}
                        documentNameProperty="name"
                        contents={productDetails?.pms_content}
                      />
                    </div>
                  </div>
                </Col>
        ...
        <div className=" mb-4 mt-4">
          <Collapse>
            <Panel
              disabled={productDetails?.after_warranty !== 'Y'}
              className="bg-white"
                ...
                <Col xl={8} lg={8} md={24} sm={24} xs={24}>
                  <div className="bg-white shadow rounded">
                    <div className="p-3 flex justify-between border-b text-sm text-gray-700 font-medium">
                      ...
                      <div>
                        <span className="text-blue-600">
                          {moment(productDetails?.contract_details?.start_date).format('LL')}
                        </span>
                      </div>
                    </div>
                    <div className="p-3 flex justify-between border-b text-sm text-gray-700 font-medium">
                      ...
                      <div>
                        <span className="text-blue-600">
                          {moment(productDetails?.contract_details?.end_date).format('LL')}
                        </span>
                      </div>
                    </div>
                    <div className="p-3 flex justify-between text-sm text-gray-700 font-medium">
                      ...
                      <div>
                        <span className="text-blue-600">
                          {productDetails?.contract_details?.period} year(s)
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <Col xl={16} lg={16} md={24} sm={24} xs={24}>
                  <div className={`${styles.AttachmentContainer} bg-white shadow rounded`}>
                    <div className="bg-white p-4 border-b">
                      ...
                      <DocumentView
                        name="Contract type"
                        value={productDetails?.contract_details?.type_desc}
                        documentNameProperty="name"
                        contents={productDetails?.contract_details?.type_content}
                      />
                    </div>
                    <div className="bg-white p-4 border-b">
                      <div className="text-lg font-semibold text-blue-600">PMS Number</div>
                      <DocumentView
                        name="PMS Number"
                        value={productDetails?.contract_details?.pms}
                        documentNameProperty="name"
                        contents={productDetails?.contract_details?.pms_content}
                      />
                    </div>
                  </div>
                </Col>
